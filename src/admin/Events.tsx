...
import { AdminConsoleClient, AdminPermission, hasAdminPermission, type AdminDeliveryPage, type AdminEventPage, type AdminEventRecord, type AdminIdentity } from './client.js';
...
export function Events({ client, identity }: { readonly client: AdminConsoleClient; readonly identity?: AdminIdentity | undefined }) {
...
function ControlEventList({ events, loading, nextCursor, canWrite, client, onChanged, onLoadMore, onSearch, onError }: { readonly events: readonly AdminControlEvent[]; readonly loading: boolean; readonly nextCursor: string | null; readonly canWrite: boolean; readonly client: AdminConsoleClient; readonly onChanged: () => Promise<void>; readonly onLoadMore: () => Promise<void>; readonly onSearch: (filters: EventFilters) => Promise<void>; readonly onError: () => void }) {
...
function ControlEventRow({ event, canWrite, client, onChanged, onError }: { readonly event: AdminControlEvent; readonly canWrite: boolean; readonly client: AdminConsoleClient; readonly onChanged: () => Promise<void>; readonly onError: () => void }) {
